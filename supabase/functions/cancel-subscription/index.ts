...
Deno.serve(async (req) => {
  ...
  if (!apiKey) {
    console.error('[CANCEL_SUBSCRIPTION] Billing provider configuration is missing.');
    return jsonError(503, 'BILLING_UNAVAILABLE', 'Subscription management is temporarily unavailable.');
  }
