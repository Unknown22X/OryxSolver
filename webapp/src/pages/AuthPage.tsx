        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-2xl shadow-slate-200/50 dark:border-slate-800 dark:bg-[#0f1115] dark:shadow-none transition-all duration-500">
          ...
          <div className="p-10 pb-8">
            ...
            <div className="text-center mb-8">
              <Link to="/" className="inline-flex mx-auto mb-6 h-16 w-16 items-center justify-center overflow-hidden rounded-[24%] transition-all hover:scale-105 active:scale-95">
            ...
            {!isConfirmingSignup && !isForgotPassword && (
              <div className="mb-6">
                ...
                <button 
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-xl border border-[#747775] bg-white py-2.5 text-sm font-bold text-[#1f1f1f] shadow-sm transition hover:bg-[#f8f9fa] disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-600 dark:bg-white dark:text-[#1f1f1f] dark:hover:bg-[#f8f9fa]"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="20" height="20" className="shrink-0 anim-pulse-once">
